# scripts/load_pitching_2_raw.py
import sqlite3
...
SHEET_NAME = "二軍基本_投球"  # ←Excelの実名に合わせて変更
...
def main():
    ...
    with sqlite3.connect(DB_PATH) as con:
        df.to_sql("pitching_2_raw", con, if_exists="replace", index=False)

    print("✅ pitching_2_raw を作成しました")
